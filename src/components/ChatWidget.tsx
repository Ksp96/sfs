...
const ChatWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-24 left-6 w-96 h-[500px] bg-card border-2 border-border rounded-2xl shadow-2xl z-40 animate-fade-in flex flex-col overflow-hidden">
          {/* Header */}
